...
const RESULT_SCHEMA =
    "shastry-sutherland-full-spin-cone-real-solve-result-v1"
...
const SOURCE_COMMIT =
    "2f87e7a0ba7fe4cf61266087d3505bc4e3b2e990"
const SOURCE_TREE =
    "03ee3970f11bb69b2375bdedc04c4465d785c8d1"
...
const EXPECTED_INPUTS = Dict(
    "0//1" => (
        ...
        output_relative=
            ...
            "ss-full-spin-cone-real-g0p8-gamma0-builder-20260729-r1",
    ),
    "1//2" => (
        model_sha256=
        ...
        output_relative=
            "tracks/polyopt/solutions/sdp-gap-seekers/results/" *
            "ss-full-spin-cone-real-g0p8-gamma0p5-builder-20260729-r1",
    ),
)

const EXPECTED_PSD_DIMENSIONS = Dict(
    "cone_reduced_full_spin_positive_centered_rx0_ry0_eigen_plus_real_psd" => 72,
    "cone_reduced_full_spin_positive_centered_rx0_ry0_eigen_minus_real_psd" => 36,
    "cone_reduced_full_spin_positive_centered_rx1_ry0_eigen_plus_real_psd" => 36,
    "cone_reduced_full_spin_positive_centered_rx1_ry0_eigen_minus_real_psd" => 45,
    "cone_reduced_full_spin_positive_scalar_rx0_ry0_eigen_plus_real_psd" => 73,
    "cone_reduced_full_spin_positive_scalar_rx0_ry0_eigen_minus_real_psd" => 36,
    "cone_reduced_full_spin_positive_scalar_rx1_ry0_eigen_plus_real_psd" => 36,
    "cone_reduced_full_spin_positive_scalar_rx1_ry0_eigen_minus_real_psd" => 45,
    "cone_reduced_full_spin_gap_gap_active_rx1_ry0_eigen_minus_real_psd" => 1,
)

const EXPECTED_SOURCE_FILES = Set([
    "tracks/polyopt/solutions/sdp-gap-seekers/scripts/" *
    "build_shastry_sutherland_full_spin_cone_reduced_mof.jl",
...
function progress(message::AbstractString)
    println("[ss-full-spin-cone-solve] ", message)
    flush(stdout)
end
...
function main(arguments::Vector{String}=ARGS)
    ...
    result = Dict(
        ...
        "representation" =>
            "exact-v4-conjugation-full-spin-cone-orbit-reduced-real-symmetric",
        "runtime" => Dict(
    ...
    exit_code = 1
    try
        progress("validating immutable full-spin cone MOF, runmeta, and SHA256SUMS")
        ...
        progress("validating fixed setup, five exact reductions, and source hashes")
