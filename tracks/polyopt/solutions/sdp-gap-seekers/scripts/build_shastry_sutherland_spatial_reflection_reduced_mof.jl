...
function progress(message::AbstractString)
    println("[ss-spatial-reflection-mof] ", message)
    flush(stdout)
end
...
function parse_args(arguments::Vector{String})
    ...
    while index <= length(arguments)
        ...
        elseif argument in ("-h", "--help")
            println(
                "usage: build_shastry_sutherland_spatial_reflection_reduced_mof.jl " *
...
function source_metadata()
    files = [
        ...
        "tracks/polyopt/solutions/sdp-gap-seekers/scripts/build_shastry_sutherland_spatial_reflection_reduced_mof.jl",
    ]
