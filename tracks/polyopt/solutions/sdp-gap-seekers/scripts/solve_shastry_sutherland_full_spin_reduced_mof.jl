...
const RESULT_SCHEMA =
    "shastry-sutherland-full-spin-real-solve-result-v1"
const RUNMETA_SCHEMA =
    "shastry-sutherland-full-spin-real-mof-runmeta-v1"
...
const SOURCE_COMMIT =
    "d799a631b2d028c077c3ce59d5511d56b4192a56"
const SOURCE_TREE =
    "ab983271df2a025f386f256e8d3bb52bac17e6d9"
...
const EXPECTED_INPUTS = Dict(
    "0//1" => (
        ...
        output_relative=
            ...
            "ss-full-spin-real-g0p8-gamma0-builder-20260729-r1",
    ),
    "1//2" => (
        model_sha256=
        ...
        output_relative=
            "tracks/polyopt/solutions/sdp-gap-seekers/results/" *
            "ss-full-spin-real-g0p8-gamma0p5-builder-20260729-r1",
    ),
)

const EXPECTED_PSD_DIMENSIONS = Dict(
    "full_spin_positive_centered_rx0_ry0_eigen_plus_real_psd" => 72,
    "full_spin_positive_centered_rx0_ry0_eigen_minus_real_psd" => 36,
    "full_spin_positive_centered_rx0_ry1_orbit_representative_real_psd" => 81,
    "full_spin_positive_centered_rx1_ry0_eigen_plus_real_psd" => 36,
    "full_spin_positive_centered_rx1_ry0_eigen_minus_real_psd" => 45,
    "full_spin_positive_scalar_rx0_ry0_eigen_plus_real_psd" => 73,
    "full_spin_positive_scalar_rx0_ry0_eigen_minus_real_psd" => 36,
    "full_spin_positive_scalar_rx0_ry1_orbit_representative_real_psd" => 81,
    "full_spin_positive_scalar_rx1_ry0_eigen_plus_real_psd" => 36,
    "full_spin_positive_scalar_rx1_ry0_eigen_minus_real_psd" => 45,
    "full_spin_gap_gap_active_rx0_ry1_orbit_representative_real_psd" => 1,
    "full_spin_gap_gap_active_rx1_ry0_eigen_minus_real_psd" => 1,
)

const EXPECTED_SOURCE_FILES = Set([
    "tracks/polyopt/solutions/sdp-gap-seekers/scripts/" *
    "build_shastry_sutherland_full_spin_reduced_mof.jl",
...
function progress(message::AbstractString)
    println("[ss-full-spin-solve] ", message)
    flush(stdout)
end
...
function validate_runmeta(
    ...
    B.require_equal(
        runmeta["claim_level"],
        "solver_free_exact_equivalent_full_spin_real_reduction",
        "runmeta claim level",
    )
...
function main(arguments::Vector{String}=ARGS)
    ...
    result = Dict(
        ...
        "representation" =>
            "exact-v4-conjugation-full-spin-permutation-invariant-real-symmetric",
        "runtime" => Dict(
    ...
    exit_code = 1
    try
        progress("validating immutable full-spin MOF, runmeta, and SHA256SUMS")
        ...
        progress("validating fixed setup, four exact reductions, and source hashes")
