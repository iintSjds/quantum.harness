...
const RUNMETA_SCHEMA =
    "triangular-heisenberg-full-spin-isotypic-real-mof-runmeta-v1"
const J1_COUPLING = 1//1

function progress(message::AbstractString)
    println("[tri-full-spin-isotypic-mof] ", message)
    flush(stdout)
end
...
function source_metadata()
    files = [
        ...
        "tracks/polyopt/solutions/sdp-gap-seekers/scripts/build_triangular_full_spin_isotypic_reduced_mof.jl",
    ]
